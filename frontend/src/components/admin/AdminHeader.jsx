    ...
    <header className="admin-header">
      <div className="admin-header__inner">
        ...
        <div className="admin-header__profile" ref={menuRef}>
          <span className="admin-header__name">{user?.username}</span>
          <button
            type="button"
          ...
          >
            <span className="admin-header__hamburger">
              <span />
              <span />
              <span />
            </span>
            <span className="admin-header__avatar">{user?.username?.[0]?.toUpperCase()}</span>
          </button>
          ...
          {menuOpen && (
            <div className="admin-header__dropdown">
              ...
              <Link to="/dashboard/reservations" onClick={() => setMenuOpen(false)}>
                My reservations
              </Link>
